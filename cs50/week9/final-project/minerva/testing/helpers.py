...
def getListOfRatios(symbol):
    ...
    # Contact API
    try:
        responseForRatios = requests.get(f"https://financialmodelingprep.com/api/v3/ratios/{urllib.parse.quote_plus(symbol)}?apikey=0ff09620ec808acc5f3088d1b6a33a3c")
        responseForRatios.raise_for_status()

        responseForIncomeStatements = requests.get(f"https://financialmodelingprep.com/api/v3/income-statement/{urllib.parse.quote_plus(symbol)}?apikey=0ff09620ec808acc5f3088d1b6a33a3c")
